...
const EndSection = () => {
  ...
  return (
    <section className="bg-white text-black py-20 px-4 md:px-8 lg:px-16 relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
        ...
        <div className="space-y-8 lg:pr-8">
          ...
          <div className="space-y-4">
            <button
              ...
              className="group relative inline-flex items-center px-8 py-4 bg-black text-white font-semibold text-lg rounded-full hover:cursor-pointer  transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
            >
        ...
        <div className="relative flex justify-center items-center">
          ...
          {/* Circular Text */}
          <div className="absolute top-8 right-8 animate-spin" style={{ animation: 'spin 20s linear infinite' }}>
            <svg viewBox="0 0 200 200" className="w-32 h-32">
              ...
              <text fill="black" fontSize="12" fontWeight="600">
