      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 md:h-20">
          ...
          <div className="hidden md:block">
            <button className="px-5 py-2 bg-black border border-blue-400/30 text-white font-medium rounded-lg hover:bg-blue-400/10 hover:border-blue-400/50 transition-all duration-300 shadow-lg shadow-blue-400/5">
              Get Started
            </button>
          </div>
        ...
        <div className="bg-black/95 backdrop-blur-lg border-t border-blue-400/20">
          <nav className="px-4 py-6 space-y-2">
            ...
            <div className="pt-4 border-t border-blue-400/20 mt-4">
              <button 
                className="w-full px-6 py-3 bg-black border border-blue-400/30 text-white font-medium rounded-lg hover:bg-blue-400/10 hover:border-blue-400/50 transition-all duration-300 shadow-lg shadow-blue-400/5"
                onClick={() => setIsOpen(false)}
              >
                Get Started
              </button>
