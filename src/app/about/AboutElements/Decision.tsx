              ...
              {decisionOptions.map((option, index) => (
                ...
                >
                  ...
                  <div className="text-center">
                    <button className="inline-flex items-center justify-center px-6 py-3 bg-black text-white font-semibold rounded-full transition-all duration-300 hover:bg-gray-800 hover:scale-105 hover:shadow-lg focus:outline-none focus:ring-4 focus:ring-gray-300 text-sm sm:text-base">
              ...
              <div className="bg-gray-50 rounded-3xl p-8 sm:p-10 lg:p-12 border-2 border-gray-100">
                <div className="max-w-3xl mx-auto">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center">
                    <button className="w-full sm:w-auto px-8 py-4 bg-black text-white font-semibold rounded-full transition-all duration-300 hover:bg-gray-800 hover:scale-105 hover:shadow-2xl focus:outline-none focus:ring-4 focus:ring-gray-300 text-base sm:text-lg">
                      Get Free Consultation
                    </button>
                    
                    <button className="w-full sm:w-auto px-8 py-4 bg-transparent text-black font-semibold rounded-full border-2 border-black transition-all duration-300 hover:bg-black hover:text-white hover:scale-105 focus:outline-none focus:ring-4 focus:ring-gray-300 text-base sm:text-lg">
                      View Case Studies
                    </button>
                  </div>
                </div>
